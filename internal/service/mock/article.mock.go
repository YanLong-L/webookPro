...
//
//	mockgen -source=article.go -package=svcmocks -destination=mock/article.mock.go ArticleService
//
...
func (m *MockArticleService) GetPublishedById(ctx *gin.Context, id, uid int64) (domain.Article, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleService) Store(ctx context.Context, article domain.Article) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleServiceMockRecorder) Store(ctx, article any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockArticleService)(nil).Store), ctx, article)
}
